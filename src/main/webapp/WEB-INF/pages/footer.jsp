            ...
            <div class="container">
                <div class="row d-flex justify-content-between">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-5 col-sm-7">
                        ...
                        <c:forEach var="popularpost" items="${popularpost}">
                            <div class="whats-right-single mb-20">
                                <div class="whats-right-img">
                                    <img src="<%= request.getContextPath() %>${popularpost.image}" alt="">
                                </div>
                                <div class="whats-right-cap">
                                    <h4><a href="<%= request.getContextPath() %>/news/${popularpost.idNews}">${popularpost.title}</a></h4>
